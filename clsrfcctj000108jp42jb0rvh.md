...
`Artillery`를 사용해 60초간 100명의 가상 사용자가 회원 가입한다고 했을 때, Class로 작성된 Express 애플리케이션의 경우, 모든 테스트를 마쳤을 때 최종 메모리 사용량은 **101.421875MB**였으며, 함수형을 작성된 코드의 경우에는 **101.234375MB**로 큰 차이가 없었다.
